      ...
      <div class="section-header text-center">
        ...
        <div class="items">
          ...
          <div>
            ...
            <p style="color:white;">Don't worry about mileage! All fuel costs are included. If you refill fuel, we'll pay you back!</p>
          </div>
          ...
          <div>
            ...
            <p style="color:white;">One size never fits all! Choose a balance of time and kilometers that works best for you.</p>
          </div>
          
          <!-- Feature 4: All-India Permits -->
          <div>
            <h3 style="color:aqua;">Go Anywhere</h3>
            <p style="color:white;">Our cars have all-India permits. Just remember to pay state tolls and entry taxes.</p>
          </div>
