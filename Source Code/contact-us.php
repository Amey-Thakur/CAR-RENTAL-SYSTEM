              ...
              foreach ($results as $result) { ?>
                <ul>
                  ...
                  <li>
                    ...
                    <div class="contact_info_m" style="color:blue;"><a href="mailto:anishaguptarp@gmail.com"
                        style="color:blue;"><?php echo htmlentities($result->EmailId); ?></a></div>
                  </li>
                  <li>
                    <div class="icon_wrap" style="color:blue;"><i class="fa fa-phone" aria-hidden="true"
                        style="color:blue;"></i></div>
                    <div class="contact_info_m"><a href="tel:61-1234-567-90"
                        style="color:blue;"><?php echo htmlentities($result->ContactNo); ?></a></div>
                  </li>
                </ul>
              <?php }
            } ?>
          ...
          <div class="contact_form gray-bg" style="background-color:black;">
            <form method="post">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control white_bg" name="message" rows="3" placeholder="Enter Your Query"
                  required></textarea>
              </div>
              <div class="form-group">
                <button class="btn" type="submit" name="send" type="submit" style="background-color:blue;">ASK US
                </button>
              </div>
            </form>
          </div>
