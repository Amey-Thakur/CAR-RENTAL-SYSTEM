...
<div class="modal fade" id="loginform">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background-color:aqua;">
      ...
      <div>
        <p><a href="#forgotpassword" data-toggle="modal" data-dismiss="modal"
            style="color:blue;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspForgot Password...?</a>&nbsp &nbsp
          ...
          &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a
            href="#signupform" data-toggle="modal" data-dismiss="modal" style="color:blue;">Make My Account...</a> </p>
      </div>
    </div>
  </div>
</div>