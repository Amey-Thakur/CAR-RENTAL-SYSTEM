 ...
 * by the user. It includes images, technical specifications, accessories, and
 ...
 * 
 * Processes the 'Book Now' form submission.
 * Validates availability and inserts booking request into 'tblbooking'.
 */
...
<body style="background-color:black;">
  ...
  <!-- Vehicle Detail Fetching -->
  <?php
  $vhid = intval($_GET['vhid']);
  // Query to get vehicle info joined with brand name
  ...
  if ($query->rowCount() > 0) {
    foreach ($results as $result) {
      $_SESSION['brndid'] = $result->bid; // Store brand ID for "Similar Cars" section
      ?>
      ...
      <section id="listing_img_slider">
        ...
        // Do nothing if image 5 is empty
      } else { ?>
                  ...
                  <div class="tab-content" style="color:blue;">
                    ...
                    <div role="tabpanel" class="tab-pane" id="accessories">
                      <table style="background-color:aqua;">
                        ...
                        <tbody>
                          <!-- Accessory Rows: Conditional Check or Cross -->
                          <tr>
      ...
      <div class="similar_cars" style="color:blue;">
        ...
        <div class="row">
          <?php
          // Query to fetch other cars of the same brand
          $bid = $_SESSION['brndid'];
              ...
              <div class="col-md-3 grid_listing">
                <div class="product-listing-m gray-bg" style="background-color:black;">
                  ...
                  <div class="product-listing-content">
                    <h5>
                      <a href="vehicle-details.php?vhid=<?php echo htmlentities($result->id); ?>" style="color:aqua;">
