                  ...
                  foreach ($results as $result) { ?>
                    <li>
                      <div class="vehicle_img"> <a
                          href="vehicle-details.php?vhid=<?php echo htmlentities($result->vid); ?>""><img src="
                          admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" alt="image"> </a> </div>
                      <div class="vehicle_title">
                        <h6><a href="vehicle-details.php?vhid=<?php echo htmlentities($result->vid); ?>"" style="
                            color:white;"> <?php echo htmlentities($result->BrandName); ?> ,
                            <?php echo htmlentities($result->VehiclesTitle); ?></a></h6>
                        <p style="color:white;"><b>From Date:</b> <?php echo htmlentities($result->FromDate); ?><br /> <b>To
                            Date:</b> <?php echo htmlentities($result->ToDate); ?></p>
                      </div>
                      <?php if ($result->Status == 1) { ?>
                        <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn"
                            style="background-color:blue;">CONFIRMED</a>
                          <div class="clearfix"></div>
                        </div>
                      <?php } else if ($result->Status == 2) { ?>
                          <div class="vehicle_status"> <a href="#" class="btn outline btn-xs"
                              style="background-color:blue;">CANCELLED</a>
                            <div class="clearfix"></div>
                          </div>
                      <?php } else { ?>
                          <div class="vehicle_status" style="color:white;"> <a href="#" class="btn outline btn-xs"
                              style="background-color:blue;">Not Confirmed</a>
                            <div class="clearfix"></div>
                          </div>
                      <?php } ?>
                      <div style="float: left" style="color:white;">
