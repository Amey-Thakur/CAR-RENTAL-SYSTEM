...
/**
 * ============================================================================
 * Car Rental Database Management System - Booking Management
 * ============================================================================
 * 
 * This file provides the administrative interface for managing vehicle bookings.
 * Admins can view booking details, including customer names, vehicle information,
 * dates, and messages. It allows for the confirmation or cancellation of 
 * individual bookings.
 * 
 * ----------------------------------------------------------------------------
...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['eid'])) {
		$eid = intval($_GET['eid']);
		$status = "2"; // 2 represents 'Cancelled' status
	...
	if (isset($_REQUEST['aeid'])) {
		...
		$status = 1; // 1 represents 'Confirmed' status
