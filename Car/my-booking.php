...
/**
 * ============================================================================
 * Car Rental Database Management System - User Bookings
 * ============================================================================
 * 
 * This file displays a private dashboard for the logged-in user to view their
 * Booking History. It retrieves booking records joined with vehicle and brand
 * information, and displays the status of each reservation (Confirmed, 
 ...
 * 
 * Verifies if the user is logged in by checking the 'login' session variable.
 * If not logged in, redirects to the login page (index.php).
 */
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8" style="background-color:black;">
        <div class="profile_wrap">
          <center>
            <h5 class="uppercase underline" style="background-color:blue;">MY BOOKING</h5>
          </center>

          <ul class="vehicle_listing">
            <?php
            // Fetch User Bookings with Vehicle and Brand details
            $useremail = $_SESSION['login'];
              ...
              foreach ($results as $result) { ?>
                ...
                <li>
                  ...
                  <div class="vehicle_title">
                    <h6>
                      <a href="vehicle-details.php?vhid=<?php echo htmlentities($result->vid); ?>" style="color:white;">
                  ...
                  <?php if ($result->Status == 1) { ?>
                    ...
                    <div class="vehicle_status">
                      <a href="#" class="btn outline btn-xs active-btn" style="background-color:blue;">CONFIRMED</a>
                      <div class="clearfix"></div>
                    </div>
                  <?php } else if ($result->Status == 2) { ?>
                      <!-- Cancelled -->
                      <div class="vehicle_status">
                        <a href="#" class="btn outline btn-xs" style="background-color:blue;">CANCELLED</a>
                        <div class="clearfix"></div>
                      </div>
                  <?php } else { ?>
                      <!-- Pending/Not Confirmed -->
                      <div class="vehicle_status" style="color:white;">
                        <a href="#" class="btn outline btn-xs" style="background-color:blue;">Not Confirmed</a>
                        <div class="clearfix"></div>
                      </div>
                  <?php } ?>
